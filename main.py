...
def make_locations_list()-> list:
    '''Gets input for number of locations and the actual locations, then puts
    them into a list.'''
    locations_list = []
...
def specified_outputs() -> list:
    '''Gets input for number of information parameters desired then gets them through
    user input and stores into an outputs list.'''
    outputs_list = []
